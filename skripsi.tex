...
\usepackage{multirow} %untuk menggabungkan baris di tabel
...
\usepackage{amsmath} %rumus
\usepackage[export]{adjustbox} %uk gbr
\usepackage{xcolor}
...
% Define the JavaScript language
\lstdefinelanguage{JavaScript}{
  keywords={typeof, new, true, false, catch, function, return, null, catch, switch, var, if, in, while, do, else, case, break, let, const, async, await},
...
%include bab 
\foreach \i in \vbab { \edef\vfile{Bab/bab\i} \IfFileExists{\vfile.tex}{\input{\vfile}}{\IfFileExists{\vfile}{\input{\vfile}}{}}} 
...
%include lampiran
\foreach \i in \vlamp { \edef\vfile{Lampiran/lamp\i} \IfFileExists{\vfile.tex}{\input{\vfile}}{\IfFileExists{\vfile}{\input{\vfile}}{}}} 
