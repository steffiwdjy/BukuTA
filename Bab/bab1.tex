...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item {Pengujian integrasi} memastikan bahwa aplikasi data capture dan model {\it machine learning} dapat bekerja secara konsisten dan stabil.
    \end{itemize}
...
\begin{enumerate}
    ...
    \item \textbf{Bab 3 Analisis dan Perancangan Sistem} \\
    ...
    \item \textbf{Bab 5 Implementasi Perangkat Lunak} \\
    Bab ini membahas mengenai penerapan rancangan sistem, di mana pembahasannya meliputi penggambaran detail antarmuka atau tampilan perangkat lunak yang telah berhasil dibangun dan kegiatan simulasi input data pada sistem.
