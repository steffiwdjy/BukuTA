...
% % Berdasarkan wawancara yang dilakukan pada tanggal 27 Maret 2025 dan 13 Oktober 2025 bersama Pengelola dan perwakilan Pelaku Komersil, teridentifikasi beberapa poin krusial terkait kondisi faktual pengelolaan saat ini:
...
\section{Analisis Masalah dan Usulan Solusi}
\label{sec:analisis}

Analisis permasalahan pada penelitian ini dilakukan melalui pendekatan kualitatif yang mencakup wawancara mendalam serta survei lapangan terhadap pemangku kepentingan utama di lingkungan Rusunami The Jarrdin Cihampelas (RTJC). Berdasarkan hasil identifikasi tersebut, tahapan penelitian dijabarkan secara sistematis ke dalam alur pemecahan masalah yang mencakup analisis kebutuhan sistem, perumusan usulan solusi, hingga implementasi akhir.

\subsection{Analisis Kebutuhan Sistem}
Berdasarkan temuan dari survei dan wawancara, diperoleh kebutuhan utama bahwa pengelola memerlukan mekanisme proaktif untuk memantau mobilitas dan mendeteksi potensi perilaku mencurigakan di area hunian secara \textit{real-time}. Hal ini melandasi kebutuhan terhadap pengembangan suatu sistem terintegrasi yang mampu mengolah data operasional secara otomatis.

\subsection{Usulan Solusi}
Sebagai solusi atas permasalahan tersebut, diusulkan pembangunan sistem dengan alur proses \textit{end-to-end} yang terdiri dari tiga tahapan utama sebagai berikut.
\begin{enumerate}
    \item Pengumpulan Data (\textit{Data Capture}):\\
    Perekaman dan pengumpulan data aktivitas serta mobilitas penghuni secara terstruktur melalui aplikasi operasional.
    \item Pengembangan Model (\textit{Model Development}):\\
    Perancangan dan pelatihan model pembelajaran mesin (\textit{machine learning}) untuk mengklasifikasikan pola perilaku anomali atau berisiko berdasarkan data historis yang tersedia.
    \item Peluncuran Model (\textit{Model Deployment}):\\
    Integrasi model yang telah dikembangkan secara langsung (\textit{embedded}) ke dalam aplikasi \textit{data capture}, sehingga sistem dapat memberikan notifikasi dini secara otomatis terkait potensi perilaku mencurigakan kepada pihak pengelola.
\end{enumerate}
...
\begin{enumerate}
    \item \textbf{Desentralisasi data dan pengelolaan manual} \\
    Saat ini, sistem penyewaan unit dikelola secara terpisah dan manual tanpa bantuan sistem teknologi terintegrasi. Tidak ada basis data terpusat yang memungkinkan pihak Pengelola untuk memantau aktivitas penyewaan secara menyeluruh. 
    \begin{itemize}
        \item Data penyewaan belum tersimpan dalam sistem digital yang terstruktur, melainkan dikelola masing-masing oleh pihak Pelaku Komersil.
    ...
    \item \textbf{Keterbatasan akses informasi dan hierarki} \\
    Pelaku komersil hanya memiliki visibilitas terhadap data unit yang mereka kelola sendiri. Kebutuhan di lapangan menunjukkan perlunya hierarki akses di mana peran otoritas Pengelola dapat melihat rekapitulasi data dari seluruh Pelaku Komersil untuk keperluan pengawasan dan evaluasi. Saat ini, belum ada sistem {Data Capture} yang memungkinkan penarikan data dari Pelaku Komersil atau penyewa untuk kebutuhan ini.

    \item \textbf{Standarisasi pencatatan dan administrasi} \\
    Input data masih bervariasi antar-Pelaku Komersil. Meskipun penyewa dan pemilik unit diwajibkan menandatangani surat perjanjian sewa untuk menghindari risiko kriminal dan kelalaian, data transaksi tersebut belum dimanfaatkan untuk analisis. Diperlukan standarisasi input digital yang mencakup hal berikut.
    \begin{itemize}
        \item Identitas penyewa (NIK) dan email Pelaku Komersil penanggung jawab.
        \item Unit kamar yang disewa.
        \item Status kewarganegaraan penyewa.
        \item Status pernikahan (pasutri/bukan) dan metode pembayaran.
...
\vspace{0.5cm} Tarif parkir di kawasan ini telah ditetapkan sebesar Rp25.000,00 per hari untuk mobil dan Rp15.000,00 untuk motor. Bagi penghuni yang berlangganan bulanan, biaya parkir motor dikenakan Rp75.000,00 dan mobil sebesar Rp150.000,00. Mengenai penanganan ketertiban, penghuni atau penyewa yang melakukan pelanggaran akan diarahkan ke area B2 untuk ditindaklanjuti oleh Pengelola, dengan melibatkan orang tua, Pelaku Komersil bersangkutan, atau pihak kepolisian jika diperlukan. Berikut terlampir dokumentasi visual yang mencakup foto unit setiap tipe, tampilan depan ruang Pelaku Komersil, serta berbagai fasilitas yang tersedia di kawasan The Jarrdin.
        ...
        Ruang Badan Pengelola berfungsi untuk mengajukan pengaduan, melakukan pembayaran parkir bulanan, dan membayar tagihan IPL.
        \begin{figure}[H]
            \centering
            \includegraphics[width=0.6\textwidth, max height=0.25\textheight]{Gambar/ruang badan Pengelola p3srs.jpg}
            \caption{Ruang Badan Pengelola}
            \label{fig:b2_2}
        \end{figure}
        \end{minipage}
        % \vspace{0.5cm}
