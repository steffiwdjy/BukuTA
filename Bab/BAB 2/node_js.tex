...
Node.js adalah lingkungan eksekusi (\textit{runtime environment}) untuk JavaScript yang bersifat \textit{open-source} dan lintas platform, dibangun di atas mesin JavaScript V8 milik Chrome. Node.js menggunakan model I/O yang bersifat \textit{non-blocking} dan \textit{event-driven} yang menjadikannya ringan dan efisien, terutama untuk aplikasi yang berjalan secara \textit{real-time} pada perangkat terdistribusi \cite{tilkov2010nodejs}.
